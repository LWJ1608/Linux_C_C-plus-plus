/**
 * @Author: lwj
 * @Date: 2022-05-30 14:44:15
 * @Description:
 * @FilePath: /Linux_C_C-plus-plus/数据结构（C++）/list/dobleLinkList/linkList.h
 **/
#include <iostream>
using namespace std;
#ifndef _LINKLIST_H_
