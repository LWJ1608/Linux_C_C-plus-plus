 ...
 * @LastEditTime: 2022-04-07 21:17:19
...
int compare_s(const void *s1, const void *s2)
{
    return ((struct Stu *)s1)->age - ((struct Stu *)s2)->age;
}
int compare_arr(const void *a1, const void *a2)
{
...
void test02() //自定义学生结构体类型
{
    ...
    qsort(stu1, 3, sizeof(stu1[0]), compare_s);
}
